...
Data Source: https://www.kaggle.com/datasets/ranasarkar15/customerchurndatasets 
...
Evaluation Objective Misalignment
 While Random Forest excels at overall classification accuracy, it is not inherently optimized for recall-driven objectives unless additional cost-sensitive mechanisms are introduced.
...
Despite applying cross-validation and selecting the best-performing configuration, the tuned Random Forest model did not achieve a significant improvement in churn recall compared to the baseline Random Forest model.
